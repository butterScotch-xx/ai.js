...
var SOM = require('./SOM');	
/**
 * The internal representation of the training data
 * {Array<Array>}
 */
var SOMdata = [];
 ...
 * @param {Object|Array<Array>|Array<Object>} data The input data. Can be array of arrays or of feature objects
 */
function scrub(data) {
